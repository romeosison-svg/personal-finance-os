...
## Current Financial Position — 2026-07-01

This position uses locked facts from `reconcile.md` and locked planning assumptions from `assumptions.md`.

---

### Cash

| Account | Balance | Available for Planning? |
| --- | ---: | --- |
| Romeo — Lloyds current | £4,980.04 | Yes — primary account |
| Romeo — Starling current | -£622.18 | No — overdrawn account |
| Kelly — Halifax current | £3,565.43 | Partial — Kelly account; Kelly-funded obligations still apply |
| Santander joint account | £200.00 | Restricted — shared bills account; needs July top-up |
| **Total household-visible cash** | **£8,123.29** | |

Notes:

- Kelly's June salary receipt is inflated by backpay; planning ratios use the locked normalised income assumption of ~£3,272.00.
- The Santander balance is an estimated current balance provided by the user.
- The Starling balance is an overdraft, so it reduces total cash.
...
| Item | Amount | Notes |
| --- | ---: | --- |
| Romeo / Amex Plan It remaining balance | £443.32 | Reconcile notes this is included in the Amex total including Plan It of £1,376.89 |

---

### Credit Cards — Kelly

| Account | Balance Owed | Minimum / DD | Due Date | Notes |
| --- | ---: | ---: | --- | --- |
| Kelly / Amex BA | £877.67 | £25.00 | 19 Jul 2026 | Assumption: Kelly self-funded unless Plan treats otherwise |
| Kelly / Halifax credit | £0.00 | — | — | Paid in full on 29 Jun 2026 |
| **Kelly credit total** | **£877.67** | | | |

---

### Balance Transfers

| Account | Balance Owed | Promo Expiry | Confirmed DD | Operational Target | Manual Top-Up |
| --- | ---: | --- | ---: | ---: | ---: |
| MBNA BT | £11,048.29 | £2,386.51 expires 03 Jun 2027; £8,661.78 expires 30 May 2028 | £276.21 | £376.00 | £99.79 |
| M&S BT | £4,283.75 | 0% promo per prior profile; expiry to verify when visible | £190.00 | £195.00 | £5.00 |
| **BT total** | **£15,332.04** | | **£466.21** | **£571.00** | **£104.79** |
...
These are known commitments and locked planning assumptions for July. This table does not allocate who pays what beyond the already-locked account or ownership notes.
...
| Item | Target | Treatment | Notes |
| --- | ---: | --- | --- |
| Kelly personal savings replenishment | £1,316.83 | Surplus-only goal | Replenishes savings used for the previous mortgage share; not a committed July liability and not required in one payment |

Separate optional cost under consideration:

| Item | Estimate | Treatment | Notes |
| --- | ---: | --- | --- |
| Plumbing work | ~£300.00 | Affordability / Plan decision | Household maintenance; not deducted as a committed liability until approved in Plan |
...
- Plumbing work estimated at ~£300.00 is tracked as an optional household maintenance item under consideration, not a committed liability.
