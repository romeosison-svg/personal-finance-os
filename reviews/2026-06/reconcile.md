...
Statement date: 31 May 2026 (all accounts)

| Account              | Holder | Statement Balance | Payments Since | Confirmed Balance | Notes |
| -------------------- | ------ | ----------------- | -------------- | ----------------- | ----- |
| Lloyds current       | Romeo  | £5,064.89         | £0             | £5,064.89         | Salary £4,654.89 received 29 May |
| Starling current     | Romeo  | -£289.26          | £0             | -£289.26          | Overdrawn — subscription account, intentional. Flag for strategy. |
| Halifax current      | Kelly  | £24.48            | £0             | £24.48            | Near-empty — expected. Salary not due until 24 June. |

**Total confirmed cash: £4,800.11**
(Romeo Lloyds £5,064.89 + Kelly Halifax £24.48 − Starling overdraft £289.26)

---

## Credit Cards — Romeo (Household Planning)

| Card           | Statement Date | Statement Balance       | Payments Since Statement | Confirmed Balance | Min Payment | Due Date    |
| -------------- | -------------- | ----------------------- | ------------------------ | ----------------- | ----------- | ----------- |
...
## Credit Cards — Kelly (Self-Funded From Savings)

Excluded from household cashflow planning per collect phase notes. Recorded here for completeness.

| Card           | Statement Date | Balance  | Min Payment | Due Date    | Status              |
| -------------- | -------------- | -------- | ----------- | ----------- | ------------------- |
| Amex           | 24 May 2026    | £774.12  | £25.00      | 18 Jun 2026 | Kelly to pay from savings |
| Halifax CC     | 07 May 2026    | £27.12   | £5.00       | 1 Jun 2026  | Kelly to pay from savings — due tomorrow |

---

## Balance Transfers — Romeo

| Card     | Statement Date | Balance    | Promo Rate | Promo Expiry | DD Amount | Next DD Date | Top-Up Required |
| -------- | -------------- | ---------- | ---------- | ------------ | --------- | ------------ | --------------- |
| MBNA     | 26 May 2026    | £9,010.78  | 0%         | 30 May 2028  | £225.27   | 22 Jun 2026  | ~£123.73 (to reach £349 target) |
| M&S Bank | 15 May 2026    | £4,478.75  | 0%         | Verify       | £190.00   | 9 Jun 2026   | ~£5.00 (to reach £195 target) |

**Total BT balance: £13,489.53**

**MBNA DD note:** Actual DD (£225.27) is below Finance Profile operational target (£349/month). DD covers minimum payment only. Manual top-up of ~£124 required to meet target.

---

## Balance Transfers — Kelly

| Card         | DD Amount | DD Source      | Balance  | Promo Expiry | Notes                                |
| ------------ | --------- | -------------- | -------- | ------------ | ------------------------------------ |
...
| Item                       | Amount    | Source         | Confirmed |
| -------------------------- | --------- | -------------- | --------- |
| Kelly's mortgage share DD  | £1,372.00 | Kelly Halifax (Santander) | ✓ |
| Romeo's mortgage contribution | TBC    | TBC            | Confirm in assumptions phase |

Total mortgage payment and Romeo's contribution method to be confirmed in assumptions phase using proportional income calculation.

---

## Direct Debits — Confirmed Collected (May, from Romeo's Lloyds)

| Payment             | Amount    | Date       |
| ------------------- | --------- | ---------- |
| L&G Insurance MI (×2) | ~£105.98 | 1 May      |
| Nuffield Health     | £53.00    | 1 May      |
| Vitality Life       | £72.17    | 1 May      |
| HMRC NDDS           | £152.67   | 5 May      |
| Vanguard Asset Mgmt | £12.00    | 18 May     |
| M&S Credit Card DD  | £190.00   | 11 May     |
| MBNA DD             | £231.05   | 21 May     |
| NHSBSA PPC 2        | £11.45    | 28 May     |
| Club Lloyds fee     | £5.00     | 5 May      |
...
| ----------------- | ----------- | ---------- | -------------- |
| Net monthly salary | £4,654.89  | 29 May 2026 | TEKSYSTEMS GLOBAL (Lloyds) |

Note: Finance Profile example figure was £5,118.56. Actual confirmed figure is **£4,654.89**. Proportional calculations in assumptions phase must use this actual figure.
...
|---|---|---|---|
| 1 | Starling overdraft | -£289.26, intentional subscription account | Flag for strategy phase — Romeo wants payoff plan |
| 2 | Kelly Virgin Money BT | £65/month DD confirmed, balance and promo expiry unknown | Add to Finance Profile after confirming details with Kelly |
| 3 | MBNA DD below target | DD £225.27 vs operational target £349 | Manual top-up ~£124 required in plan phase |
