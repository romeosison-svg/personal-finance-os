...
These assumptions are locked for YYYY-MM. Do not override without flagging as an exception.
...
- Do not ask for raw statements. All transaction data is in `reviews/YYYY-MM/transactions.csv`.
