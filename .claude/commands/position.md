...
4. Check the phase status. If already `Complete`, tell the user the position is locked and suggest running `/plan`.
...
10. If yes:
    ...
    - Instruct the user to run `/plan` to begin Phase 5.
